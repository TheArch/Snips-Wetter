...
class WeatherReport:
    ...
    def __generate_item_report(self):
        ...
        rain = ["Regenmantel", "Schirm", "Gummistiefel", "Halbschuhe", "Kaputze", "Hut"]
        ...
        if self.request.requested in ["Regenmantel", "Schirm", "Hut", "Sonnenhut", "Mantel", "Schal", "Sonnenschirm"]:
            item = "ein " + item + " ist"
    ...
    def __output_date_and_time(self):
        # lets just return what the user asked for if he
        # asked for a specific time and/or day
        if self.request.time_specified != "":
            return self.request.time_specified
        print("time_specified not used")
    ...
    def get_weather_from_open_weather_map(self, weather_api_key):
        ...
        try:
            ...
            if response["cod"] == "401":
                ...
                self.error.error_code = 6 # Error: request limit exceeded
                return self.error.error_code
